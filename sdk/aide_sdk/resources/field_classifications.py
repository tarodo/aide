...
class FieldClassificationsResource(
    BaseResource[
        FieldClassificationCreate, FieldClassificationRead, FieldClassificationCreate
    ]
):
    ...
    async def list_history(
        ...
        *,
        ...
        resp = await self.list(
            page=page,
            size=size,
            params={"field_id": str(field_id), "sort": "-created_at"},
        )
    ...
    async def list_current_by_dataset(
        ...
        data = await self._http.get(f"{self._path}/by-dataset/{dataset_id}/current")
